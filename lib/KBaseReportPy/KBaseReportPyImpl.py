...
class KBaseReportPy:
    ...
    GIT_COMMIT_HASH = "86b39b65a87c8eda7de5e721ee8b58bb990cc41e"
    ...
    def create(self, ctx, params):
        ...
        :param params: instance of type "CreateParams" (* Parameters for the
           ...
           if workspace_name is blank. Preferred as its immutable.) ->
           ...
           * @id ws), parameter "description" of String, parameter
