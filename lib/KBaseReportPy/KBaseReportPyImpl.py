...
class KBaseReportPy:
    ...
    GIT_COMMIT_HASH = "8b648f6b78054e597b3faf5d78b16f4785ea9ca1"
    ...
    def create(self, ctx, params):
        ...
        :param params: instance of type "CreateParams" (* Parameters for the
           ...
           -- only one is needed) -> structure: parameter "report" of type
           "Report" (* A simple Report of a method run in KBase. * Provides a
           fixed-width, text-based summary message, a list of warnings, * and
           a list of objects created. * @optional warnings file_links
           html_links direct_html direct_html_link_index * @metadata ws
           ...
           'ws/id/ver' * @id ws), parameter "description" of String,
           parameter "file_links" of list of type "LinkedFile" (* Represents
           a file or html archive that the report should link to * Used in
           Report and the create() function * @optional description label) ->
           ...
           type "handle_ref" (* Reference to a handle ID * @id handle),
           parameter "description" of String, parameter "name" of String,
           parameter "label" of String, parameter "URL" of String, parameter
        ...
        :returns: instance of type "ReportInfo" (* The reference to the saved
           ...
           create_extended()) -> structure: parameter "ref" of type "ws_id"
    ...
    def create_extended_report(self, ctx, params):
        ...
        :param params: instance of type "CreateExtendedReportParams" (*
           ...
           links * * string message - Simple text message to store in report
           object * list<WorkspaceObject> objects_created - List of result
           workspace objects that this app *     has created. They will get
           linked in the report view. * list<string> warnings - A list of
           warning messages in simple text * list<File> html_links - A list
           ...
           direct/default view in the *     report (ignored if direct_html is
           present). * string direct_html - simple html text that will be
           rendered within the report widget *     (do not use both this and
           html_links -- use one or the other) * list<File> file_links - a
           list of file paths or shock node IDs. Allows the user to *    
           specify files that the report widget should link for download. *
           string report_object_name - name to use for the report object *   
           (will be auto-generated if unspecified) * html_window_height -
           fixed height in pixels of the html window for the report *
           summary_window_height - fixed height in pixels of the summary
           window for the report * string workspace_name - name of workspace
           where object should be saved * int workspace_id - id of workspace
           where object should be saved * * @metadata ws length(warnings) as
           Warnings * @metadata ws length(text_message) as Message Length *
           @metadata ws length(objects_created) as Objects Created *
           @metadata ws length(html_links) as HTML Links * @metadata ws
           length(file_links) as File Links * @optional message
           objects_created warnings html_links direct_html
           direct_html_link_index file_links report_object_name
           ...
           @optional description) -> structure: parameter "ref" of type
           "ws_id" (* Workspace ID reference - eg. 'ws/id/ver' * @id ws),
           parameter "description" of String, parameter "warnings" of list of
           String, parameter "html_links" of list of type "File" (* A file to
           ...
           * Pass in *either* a shock_id or a path. If a path is given, then
           the file * will be uploaded. * @optional description) ->
           ...
           of type "File" (* A file to be linked or uploaded for the report.
           In extended_report(), * this will get converted into a lower-level
