...
function KBaseReportPy(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.create = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "KBaseReportPy.create",
     ...
     this.create_extended_report = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "KBaseReportPy.create_extended_report",
            [params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "KBaseReportPy.status",
