...
/**
 * <p>Original spec-file module name: KBaseReportPy</p>
 * <pre>
 * Module for a simple WS data object report type.
 * </pre>
 */
public class KBaseReportPyClient {
     ...
     */
    public KBaseReportPyClient(URL url) {
     ...
     * validity.
     */
    public KBaseReportPyClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KBaseReportPyClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KBaseReportPyClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public ReportInfo create(CreateParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<ReportInfo> res = caller.jsonrpcCall("KBaseReportPy.create", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public ReportInfo createExtendedReport(CreateExtendedReportParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        args.add(params);
        TypeReference<List<ReportInfo>> retType = new TypeReference<List<ReportInfo>>() {};
        List<ReportInfo> res = caller.jsonrpcCall("KBaseReportPy.create_extended_report", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("KBaseReportPy.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
